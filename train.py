...
if __name__ == '__main__':
    ...
    parser.add_argument('--wandb_project', default='klue_re_bert_chaeeun', help='wandb project name')
    parser.add_argument('--run_name', default='baseline_bert_base', help='run_name')
